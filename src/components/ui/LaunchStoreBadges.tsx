...
function AppleIcon() {
  return (
    <svg className="store-badge__icon" viewBox="0 0 384 512" aria-hidden="true">
...
function GooglePlayIcon() {
  return (
    <svg className="store-badge__icon store-badge__icon--play" viewBox="0 0 512 512" aria-hidden="true">
